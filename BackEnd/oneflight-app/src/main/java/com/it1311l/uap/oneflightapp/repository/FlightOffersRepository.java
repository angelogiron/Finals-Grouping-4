...
{
	@Insert("INSERT INTO flight_booking(queuing_office_id, creation_date, origin_location_code, round_trip_tag, number_of_passengers, reference_number, flight_offer_id, total_charged_amount) VALUES (#{queuing_office_id}, #{creation_date}, #{origin_location_code}, #{round_trip_tag}, #{number_of_passengers}, #{reference_number}, #{flight_offer_id}, #{total_charged_amount})")
